...
| 步驟 | 章節 | 你會學到什麼 | 所需時間 |
|:---:|---|---|:---:|
| 1 | [環境管理](getting_started/conda_guide.md) | 如何用 Conda 建立可重現的開發環境 | 10 分鐘 |
| 2 | [快速啟動](getting_started/contributing.md) | Clone 老師建立的專案、撰寫符合規範的程式碼 | 15 分鐘 |
...
| 步驟 | 章節 | 你會學到什麼 | 所需時間 |
|:---:|---|---|:---:|
| 5 | [日常 Git 操作](development/daily_git.md) | 分支管理、個人分支工作流 | 15 分鐘 |
| 6 | [撰寫與執行測試](development/testing.md) | 用 pytest 保護你的程式邏輯 | 15 分鐘 |
...
- [Google Python Style Guide](appendix/google_style_guide.md) — 命名、行長、Import 順序等實用規則整理
- [Type Hinting 入門](appendix/type_hinting.md) — 函式型別標注是什麼、為何重要
- [開發模式安裝（Editable Install）](appendix/editable_install.md) — `pip install -e .` 到底做了什麼
- [Google Style Docstrings](appendix/docstrings.md) — 如何為函式寫出規範的說明文件
...
**下一步 →** [環境管理](getting_started/conda_guide.md)
